class Person{
    ...
    greet() {console.log(`Hello this is ${this.firstName} ${this.lastName}`)}
...
console.log('-> __proto__ because it refers to that blueprint and dont have its own blueprint')
console.log('4. What is the difference between __proto__ and prototype?')
console.log('-> prototype is the blueprint and __proto__ refers to that blueprint')