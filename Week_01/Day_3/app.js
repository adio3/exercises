...
class Game{
    ...
    checkCollisions(){
        ...
        if((ball.posX + ball.radius > this.canvasWidth - paddleRight.paddlePosX - paddleRight.paddleWidth) && (ball.posY > (paddleRight.paddlePosY) && ball.posY < (paddleRight.paddlePosY +paddleRight.paddleHight))){
            ball.vx = -ball.vx;
        }
        if((ball.posX - ball.radius < paddleLeft.paddlePosX + paddleLeft.paddleWidth) && (ball.posY > (paddleLeft.paddlePosY) && ball.posY < (paddleLeft.paddlePosY +paddleLeft.paddleHight))){
            ball.vx = -ball.vx;
        }
    }
    createScoreLeft(){
